            ...
            try
            {
                ...
                using (var sftpClient = new SftpClient(con))
                {
                    ...
                    if (sftpClient.IsConnected)
                    {
                        ...
                        new ModuleDAL().FunInsertIntoErrorLog(System.Reflection.MethodBase.GetCurrentMethod().Name, fileid, processid, "", WorkingDirectory + ObjData.SourcePath, IssuerNo.ToString(), 1);
