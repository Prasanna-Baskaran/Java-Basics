...
namespace InstaCardsFileGeneration
{
    public class Log
    {
        public String FileNameformat = ConfigurationManager.AppSettings["LogInstaCardFile"];
        public String FolderPath = ConfigurationManager.AppSettings["LogInstaCardsPath"];
