  ...
  public class APIMessage
    {
        ...
        public string CardNo { get; set; }
        public string Status { get; set; }
        public string BlockType { get; set; } //added by uddesh for international usage RBL-ATPCM-862
        public string InternationalCard { get; set; } //added by uddesh for international usage RBL-ATPCM-862

        public string AdharToken { get; set; }
        public string SegmentCode { get; set; }

        // added by nitin 
        // used for RBL card generation 
        public string stan { get; set; }
        public string ServerIP { get; set; }
        public int Port { get; set; }
        public string ISOData { get; set; }
        public string proessingcode { get; set; }
    ...
    //public class ISOCallObject
    //{
    //    public Int32 SwitchRespID { get; set; }
    //    //public string AccountNo { get; set; }
