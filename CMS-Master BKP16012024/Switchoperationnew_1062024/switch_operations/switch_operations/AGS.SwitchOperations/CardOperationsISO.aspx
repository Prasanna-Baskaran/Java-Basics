<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="CardOperationsISO.aspx.cs" Inherits="AGS.SwitchOperations.CardOperationsISO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="phPageHeader" runat="server">
    <script>
           ...
           <%-- if ((($("#<%=txtCardStatusID.ClientID%>").val() == "0") || ($("#<%=txtCardStatusID.ClientID%>").val() == "1")) && ($("#<%=hdnAccessCaption.ClientID%>").val() == "S")) {
            ...
            $("#phPageBody_userBtns_btnSave_U").click(function () {
                ...
                if ($('#<%=txtUpdateRemark.ClientID%>').val().trim() == '') {
                    ...
                    $('#<%=txtUpdateRemark.ClientID%>').focus();
                }
                if (msg == '0') {
        ...
        function FunValidation() {
            ...
            var NICNo = $('#phPageBody_txtSearchNIC').val()
            var CIFID = $('#<%= txtSearchCIF.ClientID%>').val()
            var NameOnCard = $('#<%= txtSearchNameOnCard.ClientID%>').val()

            //if ((CardNo != "" && NICNo != "") || (CardNo != "" && CIFID != "") || (NICNo != "" && CIFID != "")) {
            //    $('#SpnErrorMsg').html('Please provide either Card No or NIC No or CIF ID');
            //    $('#errormsgDiv').show();
            //    return false;
            //}
            //else
            if (CardNo == "" && NICNo == "" && CIFID == "" && NameOnCard == "") {
                $('#SpnErrorMsg').html('Please provide Card No /NIC No /CIF ID /Name On Card');
                $('#errormsgDiv').show();
                return false;
            }
            else {
            ...
            <div id="SearchCustomer">
                <div class=" box-primary ">
                    <div class="box-header with-border">
                        ...
                        <h4 class="box-title">Card Operation :</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" maxlength="25" runat="server" name="NicNO" id="txtSearchNIC" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="inputAccountno" class="col-xs-4 control-label">Account No:</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" maxlength="25" runat="server" name="AccNO" id="txtSearchAccno" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <asp:Panel ID="pnlnameoncard" runat="server" class="col-md-6">
                                            <div class="form-group">
                                                <label for="inputNameOnCard" class="col-xs-4 control-label">Name On Card:</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" maxlength="30" runat="server" name="NameOnCard" id="txtSearchNameOnCard" />
                                                </div>
                                            </div>
                                        </asp:Panel>
                                    </div>
                        ...
                        <div id="CustomerDtlDiv">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="MotherMaidenName" class="col-xs-4 control-label">Mother's Maiden Name:</label>
                                            <div class="col-sm-8">
                                                <asp:TextBox runat="server" ID="txtMotherMaidenName" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="NicNr" class="col-xs-4 control-label">NIC No:</label>
                                            <div class="col-sm-8">
                                                <asp:TextBox runat="server" ID="txtNicNr" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="CardDetailsDiv">
                            ...
                            <div class="form-horizontal">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="inputName" class="col-xs-4 control-label">Primary Account No:</label>
                                            <div class="col-sm-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="PinTryCount" class="col-xs-4 control-label">Pin Try Count:</label>
                                            <div class="col-sm-8">
                                                <asp:TextBox runat="server" ID="txtPinTryCount" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                      <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="inputName" class="col-xs-4 control-label">Date Activated:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" runat="server" maxlength="12" name="Name" id="txtDateactivated" readonly="readonly" />
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <asp:TextBox runat="server" ID="txtUpdateRemark" CssClass="form-control" TextMode="MultiLine" onkeypress="return onlyAlphabets(event,this);"></asp:TextBox>
