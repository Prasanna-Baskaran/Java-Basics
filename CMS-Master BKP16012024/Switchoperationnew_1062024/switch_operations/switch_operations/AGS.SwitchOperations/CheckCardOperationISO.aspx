<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="CheckCardOperationISO.aspx.cs" Inherits="AGS.SwitchOperations.CheckCardOperationISO" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="phPageBody" runat="server">
    ...
    <script>
        ...
        function FunShowDetails(obj) {
            ...
            var IssuerNo = '<%=HttpContext.Current.Session["IssuerNo"]%>'

            $.ajax({
                type: "POST",
                url: "CheckCardOperationISO.aspx/FunViewDetails",
                data: '{ID:' + reqid + ',ReqTypeID:' + reqtypeid + ',SystemID:' + SystemID + ',IssuerNo:' + IssuerNo + ' }',
