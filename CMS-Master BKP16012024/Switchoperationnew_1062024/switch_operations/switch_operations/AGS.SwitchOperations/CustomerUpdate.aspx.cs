...
namespace AGS.SwitchOperations
{
    public partial class CustomerUpdate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                string OptionNeumonic = "CDU"; //unique optionneumonic from database
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((txtCifid.Value == null || txtCifid.Value == ""))
                {
                    flg = false;
                }
                ...
                {
                    new ValidatorAttr { Name = "CIF ID", Value = txtCifid.Value, MinLength = 16, MaxLength = 16, Numeric = true };
                    ...
                    //new ValidatorAttr { Name = "Account ID", Value = txtAccountNo.Value, MinLength = 0, MaxLength = 20 };
                    ...
                    else
                    {
                        ...
                        objSearch.CIF = txtCifid.Value;

                        if (!string.IsNullOrEmpty(txtAccountNo.Value))
                        {
                            objSearch.AccountNo = txtAccountNo.Value;
                        }
                        objSearch.IntPara = 0;
                        ...
                        new ClsCommonBAL().FunInsertIntoErrorLog("CS, CustomerUpdate, btnSearch_Click()", "ObjDTOutPut.rows.count=" + ObjDTOutPut.Rows.Count.ToString(), "");
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, CustomerUpdate, btnSearch_Click()", Ex.Message, "");
                hdnFlag.Value = "";
                LblResult.InnerHtml = "No record found";
            }
        }
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(hdnCardNo.Value))
                {
                    ...
                    if (ObjAPIResponse.Status.Equals("000", StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        txtMotherMaidenName.Value = ObjAPIResponse.MotherMaidenName;
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, CustomerUpdate, btnView_Click()", Ex.Message, "");
                hdnFlag.Value = "";
                LblResult.InnerHtml = "No record found";
            }
        }
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                hdnFlag.Value = LblResult.InnerText = txtMobileno.Text = LblResult.InnerText = string.Empty;

                btnSearch_Click(this, EventArgs.Empty);
            }
            catch (Exception Ex)
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, CustomerUpdate, btnCancel_Click()", Ex.Message, "");
                hdnFlag.Value = "";
                LblResult.InnerHtml = "";
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //List<ValidatorAttr> ListValid = new List<ValidatorAttr>()
                //{
                //    new ValidatorAttr { Name="Request Type", Value= txtMothername.Text, MinLength = 1, MaxLength = 1, Numeric = true, Regex="^[1-9]*$" },
                //    new ValidatorAttr { Name="Remark", Value= txtMobileno.Text, MinLength = 3, MaxLength = 80, Isrequired = true }
                //};
                ...
                //    {
                //    new ValidatorAttr { Name="Request Type", Value= txtMothername.Text.Trim(), CompareName="", CompareValue=txtCardStatus.Value.Trim() , Isrequired = true }
                //    };
                //    if (ListValid.Validate(out msg))
                //    {
                ...
                ClsCommonDAL.FunSOAL(Convert.ToString(HttpContext.Current.Session["LoginID"]), Convert.ToString(HttpContext.Current.Session["IssuerNo"]), "Card Operation", "Card Request send to Checker for |  | Mothernmae: " + txtMothername.Text, txtCardNo.Value, txtCustomerID.Value, txtCustomerName.Value, txtMobile.Value, txtAccountNo.Value, "", "Add", "1");
                //    //}
                //}
                //}
            }
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, CustomerUpdate, btnSave_Click()", ObjEx.ToString(), "");
            }
        }
        ...
        //    {
        //        DataTable ObjDTOutPut = new DataTable();
        //        ObjDTOutPut = new ClsCommonBAL().FunGetCommonDataTable(34, "1");
        ...
        //    catch (Exception Ex)
        //    {
        //        new ClsCommonBAL().FunInsertIntoErrorLog("CS, CustomerUpdate, FillDropDown()", Ex.Message, "");
        //    }
        ...
        protected void AcceptRejectCardOpsRequests(object sender, EventArgs e)
        {
            try
            {
                ...
                objSearch.CIF = txtCifid.Value;
                objSearch.MotherName = txtMothername.Text;
                objSearch.MobileNo = txtMobileno.Text;
                objSearch.RequestIDs = "10";
                ...
                if (_DTCardOpsDataISO.Rows.Count > 0)
                {
                    ...
                    _DTCardOpsDataISO.Rows[0][0] = objSearch.CIF;
                    //ObjData.IsCardDetailsSearch = true;                    
                    ...
                    for (int i = 0; i < _DTCardOpsDataISO.Rows.Count; i++)
                    {
                        ...
                        else if (objSearch.RequestTypeID == 8)
                        {
                            _dtRequest.Columns.Add("CardNo", typeof(string));
                            _dtRequest.Rows.Add(new Object[] { _DTCardOpsDataISO.Rows[i][0] });
                        }
                        else
                        {
                            ...
                            _dtRequest.Columns.Add("MothersMaidenName", typeof(string));
                            _dtRequest.Columns.Add("MobileNo", typeof(string));
                            //_dtRequest.Rows.Add(new Object[] { objSearch.CIF, _DTCardOpsDataISO.Rows[i][0], objSearch.MotherName, objSearch.MobileNo });
                            _dtRequest.Rows.Add(new Object[] { "5114|" + objSearch.CIF + "|" + objSearch.MobileNo + "|" + objSearch.MotherName, _DTCardOpsDataISO.Rows[i][0], objSearch.MotherName, objSearch.MobileNo });
                    ...
                    {
                        LblResult.InnerHtml = "Customer data successfully";//"Success Cards : " + removeLastChar(SuccessCardNo);                                               
                    }
                    if (!string.IsNullOrEmpty(FailuerCardNo))
                    {
                        LblResult.InnerHtml = LblResult.InnerHtml + "Failed";//"<br/>Failuer Cards : " + removeLastChar(FailuerCardNo);
                    }
                }
                else
                {
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, CheckCardOperation, AcceptRejectCardOpsRequests()", Ex.Message, "Mothername = " + txtMothername.Text);
            }
        }
