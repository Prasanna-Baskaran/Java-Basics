<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="PinIssuance_RDB.aspx.cs" Inherits="AGS.SwitchOperations.PinIssuance_RDB" %>
            ...
            <div id="SearchCustomer">
                <div class=" box-primary ">
                    <div class="box-header with-border">
                        ...
                        <h4 class="box-title">Pin Issuance :</h4>
                        ...
                        <div id="CardDetailsDiv">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="inputName" class="col-xs-4 control-label">NIC No:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" runat="server" maxlength="15" name="Name" id="txtCustNicNo" readonly="readonly" />
                                            </div>
                                        </div>
                                    </div>
