...
{
    public partial class PinIssuance_RDB : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        new ClsCommonBAL().FunInsertIntoErrorLog("CS, PinIssuance_RDB, btnSearch_Click()", "ObjDTOutPut.rows.count=" + ObjDTOutPut.Rows.Count.ToString(), "");
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, PinIssuance_RDB, btnSearch_Click()", Ex.Message, "");
                hdnFlag.Value = "";
                LblResult.InnerHtml = "No record found";
            }
        }
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(hdnCardNo.Value))
                {
                    ...
                    if (ObjAPIResponse.Status.Equals("000", StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        if (string.IsNullOrWhiteSpace(ObjAPIResponse.HoldRspCode))
                        {
                        ...
                        txtCustNicNo.Value = ObjAPIResponse.NicNr;
                        LblResult.InnerHtml = "";
                        hdnFlag.Value = "2";
                        hdnRPANID.Value = "";
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, PinIssuance_RDB, btnView_Click()", Ex.Message, "");
                hdnFlag.Value = "";
                LblResult.InnerHtml = "No record found";
            }
        }
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, PinIssuance_RDB, btnCancel_Click()", Ex.Message, "");
                hdnFlag.Value = "";
                LblResult.InnerHtml = "";
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, PinIssuance_RDB, btnSave_Click()", ObjEx.ToString(), "");
            }
        }
        ...
        public void FillDropDown()
        {
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, PinIssuance_RDB, FillDropDown()", Ex.Message, "");
            }
        ...
        protected void AcceptRejectCardOpsRequests(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_DTUpdateCardOpsRSP.Rows.Count == 0)
                {
                    if (_DTCardOpsDataISO.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < _DTCardOpsDataISO.Rows.Count; i++)
                        {
                            ...
                            else if (objSearch.RequestTypeID == 9)
                            {
                                _dtRequest.Columns.Add("CardNo", typeof(string));
                                _dtRequest.Rows.Add(new Object[] { _DTCardOpsDataISO.Rows[i][0] });
                            }
                        ...
                        {
                            if (objSearch.RequestTypeID == 8)
                            {
                                LblResult.InnerHtml = "Card Pin has been reset successfully";//"Success Cards : " + removeLastChar(SuccessCardNo);
                            }
                            else
                            {
                                LblResult.InnerHtml = "Card Pin Issue has been successfully";
                            }
                        }
                ...
                {
                    LblResult.InnerHtml = "Already Request Issued";
                }
