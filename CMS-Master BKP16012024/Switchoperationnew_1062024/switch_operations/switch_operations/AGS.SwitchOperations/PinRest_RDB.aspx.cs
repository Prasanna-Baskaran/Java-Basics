...
{
    public partial class PinRest_RDB : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                string OptionNeumonic = "PRE"; //unique optionneumonic from database
        ...
        public void FillDropDown()
        {
            ...
            {
                DataTable ObjDTOutPut = new DataTable();
                ObjDTOutPut = new ClsCommonBAL().FunGetCommonDataTable(35, "1");
