    ...
    public partial class Reports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string OptionNeumonic = "ACTR"; //unique optionneumonic from database
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
              ...
              //  new ClsCommonBAL().FunInsertIntoErrorLog("CS, TransactionReport, btnSearch_Click() DT" + objSearch.FromDate.ToString() + " ," + objSearch.ToDate.ToString(), "", "");
                ...
                ObjDTOutPut = new ClsCardMasterBAL().FunGetAuditReports(objSearch);
            ...
            {
                new ClsCommonBAL().FunInsertIntoErrorLog("CS, AuditReport, btnSearch_Click()" + txtSearchFromDate.Value + " ," + txtSearchToDate.Value, ObjEx.Message, "");
            }
        }
