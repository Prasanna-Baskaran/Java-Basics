                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="inputName" class="col-xs-4 control-label">CardNo:</label><%--<span style="color: red;">*</span>--%><div class="col-sm-8">
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content" style="border-radius: 6px">
                    <div class="modal-header box-primary" style="border-top-right-radius: 6px; border-top-left-radius: 6px">
                        ...
                        <h4 id="myLargeModalLabel" class="modal-title" style="font-weight: bold">Account Linking Delinking Status</h4>
                    </div>
            ...
            $('[id$="BtnSave"]').click(function () {
                ...
                $('#datatable-buttons tbody').find('tr').each(function () {
                    if ($(this).find('input[type="checkbox"]:checked').length > 0) {
                        ...
                        var accNo = $(this).find('td:nth-child(5)').text();

                        var customername = $(this).find('td:nth-child(2)').text();
                        var lastnm = $(this).find('td:nth-child(3)').text();
                        var fullname = $(this).find('td:nth-child(4)').text();
                        var emailid = $(this).find('td:nth-child(6)').text();
                        var mobileno = $(this).find('td:nth-child(7)').text();
                        var nicno = $(this).find('td:nth-child(8)').text();
                        var mothername = $(this).find('td:nth-child(9)').text();
                        var add1 = $(this).find('td:nth-child(10)').text();
                        var add2 = $(this).find('td:nth-child(11)').text();
                        //var add3 = $(this).find('td:nth-child(11)').text();
                        //var add4 = $(this).find('td:nth-child(12)').text();
                        //var add5 = $(this).find('td:nth-child(13)').text();                        
                        var dob = $(this).find('td:nth-child(12)').text();

                        //alert(add6);
                        if (allids == "") {
                            //allids = id + "|" + accNo + "|" + qualifier;
                            allids = id + "|" + accNo + "|" + qualifier + "|" + customername + "|" + fullname + "|" + emailid + "|" + mobileno + "|" + nicno + "|" + mothername + "|" + add1 + "|" + add2 + "|" + dob + "|" + lastnm;
                        } else {
                            //allids = allids + "," + id + "|" + accNo + "|" + qualifier;
                            allids = allids + "," + id + "|" + accNo + "|" + qualifier + "|" + customername + "|" + fullname + "|" + emailid + "|" + mobileno + "|" + nicno + "|" + mothername + "|" + add1 + "|" + add2 + "|" + dob + "|" + lastnm;
                            //allids = allids + "," + id + "|" + accNo + "|" + qualifier + "|" + customername + "|" + fullname + "|" + emailid + "|" + mobileno + "|" + nicno + "|" + mothername + "|" + add1 + "|" + add2 + "|" + add3 + "|" + add4 + "|" + add5 + "|" + dob;
                        }
                        if (allqualifiers == "") {
                ...
                $('#datatable-buttons tbody').find('tr').each(function () {
                    if ($(this).find('input[type="checkbox"]:checked').length > 0) {
                        ...
                        if (allids == "") {
                            //allids = id + "|" + accNo + "|" + qualifier;
                            allids = id + "|" + accNo + "|" + qualifier + "|" + customername + "|" + fullname + "|" + emailid + "|" + mobileno + "|" + nicno + "|" + mothername + "|" + add1 + "|" + add2 + "|" + dob + "|" + lastnm;
                            //allids = id + "|" + accNo + "|" + qualifier + "|" + customername + "|" + fullname + "|" + emailid + "|" + mobileno + "|" + nicno + "|" + mothername + "|" + add1 + "|" + add2 + "|" + add3 + "|" + add4 + "|" + add5;
                        } else {
                            //allids = allids + "," + id + "|" + accNo + "|" + qualifier;
                            allids = allids + "," + id + "|" + accNo + "|" + qualifier + "|" + customername + "|" + fullname + "|" + emailid + "|" + mobileno + "|" + nicno + "|" + mothername + "|" + add1 + "|" + add2 + "|" + dob + "|" + lastnm;
                        }
