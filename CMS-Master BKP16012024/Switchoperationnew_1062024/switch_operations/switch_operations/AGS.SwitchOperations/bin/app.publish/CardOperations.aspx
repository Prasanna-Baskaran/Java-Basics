<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="CardOperations.aspx.cs" Inherits="AGS.SwitchOperations.CardOperations" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="phPageHeader" runat="server">    
    <script>
        $(document).ready(function () {
            ...
            if ($('#<%=ddlRequestType.ClientID%>').val() == '0') {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" maxlength="25" runat="server" name="CardNO" id="txtSearchName" onkeypress="return onlyAlphabets(event,this);" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
