<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="PinOperationsReports.aspx.cs" Inherits="AGS.SwitchOperations.PinOperationsReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="phPageBody" runat="server">
    ...
    <div class="box-primary">
        <div class="box-header with-border">
            ...
            <h2 class="box-title">Pin Operations Report </h2>
        </div>
