<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="~/SDF/Login.aspx.cs" Inherits="AGS.SwitchOperations.SDF.SDFLogin" %>
...
<head>
    ...
    <script type="text/javascript">
        function FunShowLoader() {
            if ($('#txtUsername').val() != "" && $('#txtPwd').val() != "" && $('#answer').val() != "") {
                $('.shader').fadeIn();
                return true
            }
        }
...
<body class="login">
    ...
    <div>
        <form runat="server" id="frmLoginSDF">
                        ...
                        <section class="login_content">
                            ...
                            <div class="login-form">
                                ...
                                <div>
                                    ...
                                    <input type="password" class="form-control" placeholder="Username" required="" runat="server" id="txtUsername" onpaste="return false;" autocomplete="off" />
                                </div>
                                <div>
                            ...
                            <a class="btn btn-default submit" href="#">Reset</a>--%>
                                        <asp:Button runat="server" ID="btnLogin" OnClientClick="return checkAnswer()" OnClick="btnLogin_Click" Text="Log in" CssClass="btn btn-block btn-primary submit" />
                                </div>
