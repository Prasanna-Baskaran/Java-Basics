...
function loginPageLoad(f) {
    ...
    $('#btnLogin').click(function () {
        ...
        $('[id$="txtPwd"]').val(EncryptLocalAGS(btoa($pass)));
        var $pass1 = $('[id$="txtUsername"]').val();
        $('[id$="txtUsername"]').val(EncryptLocalAGS(btoa($pass1)));
    });
...
function ConvPass() {
    ...
    var $pass01 = $('[id$="txtCurrentPassword"]').val();
    $('[id$="txtCurrentPassword"]').val(EncryptLocalAGS($pass01));
    var $pass02 = $('#phPageBody_txtNewPassword').val();
    $('#phPageBody_txtNewPassword').val(EncryptLocalAGS($pass02));
    var $pass03 = $('#phPageBody_txtConfirmNewPassword').val();
    $('#phPageBody_txtConfirmNewPassword').val(EncryptLocalAGS($pass03));
