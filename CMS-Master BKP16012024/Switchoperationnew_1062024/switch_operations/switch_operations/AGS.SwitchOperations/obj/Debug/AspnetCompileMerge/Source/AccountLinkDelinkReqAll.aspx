<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="AccountLinkDelinkReqAll.aspx.cs" Inherits="AGS.SwitchOperations.AccountLinkDelinkReqAll" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="phPageBody" runat="server">
                ...
                <div class="box-primary">
                    ...
                    <div class="box-body">
                            ...
                            <div class="form-horizontal">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 text-center">
                                        <div class="form-group">
                                            <asp:Button runat="server" CssClass="btn btn-primary" ID="btnSearch" Text="Search" OnClick="btnSearch_Click" OnClientClick="return FunSearchValidation();" />
                                        
                                            <asp:Button runat="server" CssClass="btn btn-primary" ID="BtnSyncData" Text="Add Account" OnClick="BtnSyncData_Click" OnClientClick="return funAddNew();" />
                        ...
                        <div class="row" id="DivResultMsg">
                            ...
                            <div class="col-md-6">
                                <input type="button" class="btn btn-primary pull-right hidden" runat="server" id="BtnAddNew" data-targrt="#AddEditModal" value="Add New" onclick="funAddNew(); " />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="border-radius: 4px; width: 797px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="inputName" class="col-md-5 control-label">Card No:</label>
                            <div class="col-md-7">
                                <asp:Label runat="server" ID="lblCardNo" for="inputName" class="col-md-5 control-label"></asp:Label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="inputName" class="col-md-5 control-label">CIF No:</label>
                            <div class="col-md-7">
                                <asp:Label runat="server" ID="lblCIF" for="inputName" class="col-md-5 control-label"></asp:Label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="inputName" class="col-md-5 control-label">NIC No:</label>
                            <div class="col-md-7">
                                <asp:Label runat="server" ID="lblNIC" for="inputName" class="col-md-5 control-label"></asp:Label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="inputName" class="col-md-5 control-label">Name On Card:</label>
                            <div class="col-md-7">
                                <asp:Label runat="server" ID="lblNameOnCard" for="inputName" class="col-md-5 control-label"></asp:Label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                <asp:DropDownList ID="ddlCurrencyCode" runat="server" class="form-control" Style="width: 100%">
                                    <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="144" Value="144"></asp:ListItem>
                        ...
                        <div class="col-md-6">
                            <asp:CheckBox ID="CheckAccountQuantifier" runat="server" CssClass="hidden" />
                                <label for="inputName" class="col-md-5 control-label"><span style="color: red;"></span>AccountQualifier:</label>
                            <div class="col-md-7">
                                    <asp:DropDownList ID="ddlAccQual" runat="server" class="form-control" Style="width: 100%">
    ...
    <script>
        function FunClear() {
            ...
            document.getElementById("<%=CheckAccountQuantifier.ClientID %>").checked = false;
            document.getElementById("<%=ddlAccQual.ClientID %>").selectedIndex = 0;
            document.getElementById("<%=ddlCurrencyCode.ClientID %>").selectedIndex = 0;
    ...
    <script>
        ...
        function funAddNew() {
            ...
            //if (CardNo == null || CardNo == "")
                //CardNo = $('#<%= hdnCardNo.ClientID%>').val()
            var CIFId = $('#<%=txtCIF.ClientID%>').val()
            // Added by nitin on 02/11/2019
            ...
            if (CIFId == "" && NICNo == "" && CardNo == "" && NameOnCard == "") {
                //$('#SpnErrorMsg').html('Please provide CIF');
                //$('#errormsgDiv').show();
                //return false;
                ErrorMsg = ErrorMsg + "CIFId / NICNo / CardNo / Name On Card,";
            }
            //end
    ...
    <script>
        ...
        function FunAddEditModalShow() {
            $('#AddEditModal').modal('show');
        }

        function FunAddEditModalHide() {
            $('#AddEditModal').modal('hide');
        }
