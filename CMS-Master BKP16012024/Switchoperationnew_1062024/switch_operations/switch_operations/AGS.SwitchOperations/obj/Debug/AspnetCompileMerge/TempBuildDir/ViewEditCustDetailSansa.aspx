<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="ViewEditCustDetailSansa.aspx.cs" Inherits="AGS.SwitchOperations.ViewEditCustDetailSansa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="phPageBody" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" maxlength="10" runat="server" name="SearchMobile" id="txtSearchMobile" onkeypress="return FunChkIsNumber(event)" />
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="form-horizontal">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-7">
                                                                        ...
                                                                        <%--          <input type="text" class="form-control datepicker" placeholder="DOB" runat="server" id="txtDOB"  maxlength="10" />--%>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="inputName" class="col-xs-4 control-label"><%--<span style="color: red;">*</span>--%>BID No:</label>
                                                                    <div class="col-sm-7">

                                                                        <input type="text" class="form-control" maxlength="15" placeholder="Business Registration Number"
                                                                            runat="server" name="MotherName" id="txtBuisnessRegNo"
                                                                            onkeypress="return FunChkAlphaNumeric(event)" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="inputName" class="col-xs-4 control-label"><%--<span style="color: red;">*</span>--%>Account Category:</label>
                                                                    <div class="col-sm-7">
                                                                        <asp:DropDownList ID="DDLAccCat" runat="server" class="form-control">
    ...
    <script>
        $(document).ready(function () {
            ...
            if ($("#datatable-buttons tbody tr").length > 0) {
                ...
                //remove view button for inactive cards
                $("#datatable-buttons tbody tr td input[btnstatus='Inactive']").remove();
   ...
   <%--         $("#<%=hdnFlagId.ClientID%>").val('2')--%>
            ...
            $('#<%= DDLAccCat.ClientID%>').attr("disabled", true);
            ...
            $('[id$="txtMotherName"]').prop('readonly', false);
            $('#<%=txtBuisnessRegNo.ClientID%>').prop('readonly', true);
    ...
    <script>
        ...
        function FunValidation() {
            ...
            if ((CardNo == "") && (Mobile == "") && (AccountNo == "") && (Name == "") && (CIFNo == "") && (CIFNo == "") && (NicNo == "")) {
                $('#SpnValidMsg').html('Please provide Card No /CIF No/ NIC No /Mobile No /Name /Account No ');
                $('#ValidateMsgDiv').show();
                $('#divResult').hide();
                return false;
            }
    ...
    <script>
      <%--  $('[id$="btnUpdate"]').click(function () {
            ...
            var LinkedAcc = $("#<%=hdnLinkedAccList.ClientID%>").val();
              var hdnAlertAccList = $("#<%=hdnAlertAccList.ClientID%>").val();
                ...
                if (allids == '') {
                    ...
                    if (errorFieldsAD != '') {
                        errorFieldsAD = errorFieldsAD + '<b>, Please check at least one checkbox to Account Linking.</b> ';
                    }
                    else {
                        errorFieldsAD = errorFieldsAD + '<b>Please check at least one checkbox to Account Linking</b> ';
                    }
                    ...
                    if (errorFieldsAD != '') {
                        errorFieldsAD = errorFieldsAD + '<b>, Please select different account qualifier.</b> ';
                    }
                    else {
                        errorFieldsAD = errorFieldsAD + '<b>Please select different account qualifier</b> ';
                    }
           ...
           // $("#<%=hdnacclinkData.ClientID %>").val($('#datatable-buttonsAcclink').html());
    ...
    <script>
        ...
        $('[id$="btnUpdate"]').click(function () {
            ...
            if (allids == '') {
                ...
                if (errorFieldsAD != '') {
                    errorFieldsAD = errorFieldsAD + '<b>, at least one checkbox to Account Linking.</b> ';
                }
                else {
                    errorFieldsAD = errorFieldsAD + '<b>at least one checkbox to Account Linking</b> ';
                }
            ...
            var acid='';
            var ch = $('#datatable-buttonsAcclink td input[type=checkbox]:checked').closest('tr').find('select option:selected');
            ch.each(function () {
                if ($(this).val() == 1) {
                    acid=$(this).closest('tr').find('td:nth-child(2)')[0].innerHTML;
                }
            });
            $('#errormsgDiv').hide();
            var _RegistrationDet = {
                ...
                //CardNo: $("[id$='txtSearchCardNo']").val(),
                CardNo: $("#<%=hdnCardDetails.ClientID%>").val(),
                ...
                AccCategory: $("#<%=DDLAccCat.ClientID %> option:selected").text(),
                BusinessRegNo: $("#<%=txtBuisnessRegNo.ClientID %>").val(),
                ACID: acid

            }

            alert('Validation completed, calling web method!');

                $('.shader').fadeIn();
                $.ajax({
                    type: "POST",
                    url: 'ViewEditCustDetailSansa.aspx/btnUpdate',
                    data: {},
    ...
    <script>
        function funViewClick(obj) {
            ...
            var Carddetail = $(obj).attr('CardNo');
            var CIFId = $(obj).attr('CIFId');
            //alert(CIFId);

            $("[id$='hdnCustomerID']").val(CustomerID);
            $("[id$='hdnTblAuthId']").val(AuthId);
            $("#<%=hdnCardDetails.ClientID%>").val(Carddetail);
            $("#<%=hdncifid.ClientID%>").val(CIFId);
    ...
    <script>
        function FunOperation() {
            ...
            if ($("#phPageBody_hdnFlagId").val() == "1") {
                ...
                $("#<%=DDLAccCat.ClientID%>").prop('disabled', true);
