...
.dataTables_wrapper.no-footer div.dataTables_scrollBody table {
  border-bottom: none;
       ...
       .dataTable>tbody>th,
        ...
        /*.dataTables_scrollHead{  overflow:auto;}*/
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function (event) {
            ...
            $(".accordian").click(function () {
                ...
                $("div[class^='acco_'].panel table").DataTable().columns.adjust();
            })
                                        ...
                                        <div class="col-md-12">
                                            <div class="x_panel">
                                                <div class="">
                                                    ...
                                                    <input type="button" value="Reject" onclick="funGetResult(2)" id="BtnReject" class="btn-div btn-style btn btn-primary"  OnClientClick="return $('.shader').fadeIn();" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        function SetISOData() {
            ...
            $('div[class^="acco_"].panel table tbody').find('tr').each(function () {
                if ($(this).find('input[type="checkbox"]:checked').length > 0) {
                    ...
                    var linkFlag = $(this).find('td:nth-child(6)').text();
                    var accType = $(this).find('td:nth-child(7)').text();
                    var accQua = $(this).find('td:nth-child(8)').text();

                    var customername = $(this).find('td:nth-child(10)').text();
                    var fullname = $(this).find('td:nth-child(11)').text();
                    var emailid = $(this).find('td:nth-child(12)').text();
                    var mobileno = $(this).find('td:nth-child(13)').text();
                    var nicno = $(this).find('td:nth-child(14)').text();
                    var mothername = $(this).find('td:nth-child(15)').text();
                    var add1 = $(this).find('td:nth-child(16)').text();
                    var add2 = $(this).find('td:nth-child(17)').text();
                    //var add3 = $(this).find('td:nth-child(18)').text();
                    //var add4 = $(this).find('td:nth-child(19)').text();
                    //var add5 = $(this).find('td:nth-child(20)').text();
                    var dob = $(this).find('td:nth-child(18)').text();
                    var lastnm = $(this).find('td:nth-child(19)').text();

                    if (Record == '')
                        //Record = id + '|' + cardNo + '|' + accNo + '|' + accType + '|' + accQua + '|' + linkFlag + '|' + custId;
                        Record = id + '|' + cardNo + '|' + accNo + '|' + accType + '|' + accQua + '|' + linkFlag + '|' + custId + "|" + customername + "|" + fullname + "|" + emailid + "|" + mobileno + "|" + nicno + "|" + mothername + "|" + add1 + "|" + add2 + "|" + dob + "|" + lastnm;
                    else
                        //Record = Record + "," + id + '|' + cardNo + '|' + accNo + '|' + accType + '|' + accQua + '|' + linkFlag + '|' + custId;
                        Record = Record + "," + id + '|' + cardNo + '|' + accNo + '|' + accType + '|' + accQua + '|' + linkFlag + '|' + custId + "|" + customername + "|" + fullname + "|" + emailid + "|" + mobileno + "|" + nicno + "|" + mothername + "|" + add1 + "|" + add2 + "|" + dob + "|" + lastnm;
                }
            });
