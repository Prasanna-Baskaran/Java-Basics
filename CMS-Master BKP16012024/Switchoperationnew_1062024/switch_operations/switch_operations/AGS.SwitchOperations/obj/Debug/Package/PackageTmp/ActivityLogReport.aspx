<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="ActivityLogReport.aspx.cs" Inherits="AGS.SwitchOperations.ActivityLogReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="phPageHeader" runat="server">
    ...
    <script>
        ...
        function FunValidation() {
            ...
            //}
            //if (CardNo == "" && RRN =="") {
            //    errorFieldsDD = errorFieldsDD + (errorFieldsDD != '' ? '<b>,' : '<b>') + ' CardNo/RRN</b> ';
            //}
            //added by uddesh ATPCM-656 end
            if (CardNo == "") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="phPageBody" runat="server">
    ...
    <div class="box-primary">
        <div class="box-header with-border">
            ...
            <h2 class="box-title">Activity Log Report </h2>
        </div>
            ...
            <div class="form-horizontal">
                <div class="row">
                    ...
                    <div class="row">
                         <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputName" class="col-xs-4 control-label">Log Type:</label>
                                <div class="col-sm-8">
                                    <asp:DropDownList runat="server" ID="ddlReportType" CssClass="form-control">
                                        <asp:ListItem Text="Card Operations" Value="SwitchOperation"></asp:ListItem>
                                        <asp:ListItem Text="User Operations" Value="UserModule"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
