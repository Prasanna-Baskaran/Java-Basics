<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="ActivityReport.aspx.cs" Inherits="AGS.SwitchOperations.ActivityReport" %>
                    ...
                    if ($("#datatable-buttons").length) {
                        $("#datatable-buttons").DataTable({
                         ...
                         },
                         {
                             extend: "csv",
                             className: "btn-sm",
                             title: 'ActivityReport_' + d.getDate() + "_" + (d.getMonth() + 1) + "_" + d.getFullYear() + "_" + d.getHours() + "_" + d.getMinutes() + "_" + d.getSeconds()
                         },
                         //{
                         //    extend: "excel",
                         //    className: "btn-sm"
...
<asp:Content ID="Content2" ContentPlaceHolderID="phPageBody" runat="server">
    ...
    <div class="box-primary">
        <div class="box-header with-border">
            ...
            <h2 class="box-title">Activity Report </h2>
        </div>
...
<%--                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                                    <div class="col-sm-4">
                                        <asp:Button runat="server" CssClass="btn btn-primary pull-right" ID="Button1" Text="Search" OnClick="btnSearch_Click"/>
                                    </div>
                                </div>
