<%@ Page Title="" Language="C#" MasterPageFile="~/SwitchOperationSite.Master" AutoEventWireup="true" CodeBehind="CardTypeMaster.aspx.cs" Inherits="AGS.SwitchOperations.CardTypeMaster" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="phPageBody" runat="server">
    ...
    <div class="box-primary">
        <div class="box-header with-border">
            ...
            <h2 class="box-title">Card Type </h2>
        </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content" style="border-radius: 6px">
                <div class="modal-header box-primary" style="border-top-right-radius: 6px; border-top-left-radius: 6px">
                    ...
                    <h4 id="myLargeModalLabel" class="modal-title" style="font-weight: bold">Card Type</h4>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="border-radius: 4px;">
                ...
                <div class="modal-header">
                    ...
                    <h4 id="myLargeModaldelete" class="modal-title" style="font-weight: bold">Card Type</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <label for="inputName" class="col-xs-4 control-label">Card Type:</label>
                        <div class="col-sm-7">
                    ...
                    <div class="row">
                        <label for="inputName" class="col-xs-4 control-label">Description:</label>
                        <div class="col-sm-7">
    ...
    <script>
        ...
        function funEditClick(obj) {
            ...
            var ID = $(obj).attr('id');
            var INSTID = $(obj).attr('cardtype');
            var INSTIDesc = $(obj).attr('cardtypedesc');
